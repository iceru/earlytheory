                ...
                <div class="form-payment col-12">
                    ...
                    <div class="form-group ">
                        ...
                        <select class="form-control-plaintext" name="inputRelationship" id="inputRelationship" disabled>
                            ...
                            <option value="single" @if ($sales->user->relationship == "single") {{ 'selected' }} @endif
                                disabled>Single</option>
                            <option value="pacaran" @if ($sales->user->relationship == "pacaran") {{ 'selected' }} @endif
                                disabled>Pacaran</option>
                            <option value="menikah" @if ($sales->user->relationship == "menikah") {{ 'selected' }} @endif
                                disabled>Menikah</option>
                            <option value="divorced" @if ($sales->user->relationship == "divorced") {{ 'selected' }} @endif
                    ...
                    <div class="form-group ">
                        ...
                        <select class="form-control-plaintext" name="inputPekerjaan" id="inputPekerjaan" disabled>
                            <option selected disabled>Select</option>
                            <option value="unemployed" @if ($sales->user->job == "unemployed") {{ 'selected' }} @endif
                                disabled>Unemployed</option>
                            <option value="employed" @if ($sales->user->job == "employed") {{ 'selected' }} @endif
                                disabled>Employed</option>
                            <option value="business" @if ($sales->user->job== "business") {{ 'selected' }} @endif
                                disabled>Business</option>
                            <option value="student" @if ($sales->user->job == "student") {{ 'selected' }} @endif
