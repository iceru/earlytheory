        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" enctype="multipart/form-data" action="/admin/workshops/store">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="desc" id="desc" cols="30" rows="6"></textarea>
                    </div>
                </div>
                <div class="mb-3 row">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="ratio ratio-1x1">
                                    <img src="{{ Storage::url('public/article-image/' . $workshop->image) }}"
                                        alt="Image" width="100">
                                </div>
                            </td>
                            ...
                            <td>{{ $workshop->time_read }}</td>
                            <td style="color: {{ $workshop->accent_color }}">{{ $workshop->accent_color }}</td>
