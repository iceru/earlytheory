                                                        ...
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                                ...
                                                                <div
                                                                    style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <strong>Jam Lahir:</strong>
                                                                    </p>
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        {{ $additional->birthtime }}
                                                                    </p>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                                ...
                                                                <div
                                                                    style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <strong>Tambahan Cari Tahu Jam Lahir:</strong>
                                                                    </p>
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        {{ $additional->checkbirthtime ? 'Ya' : 'Tidak' }}
                                                                    </p>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                                ...
                                                                <div
                                                                    style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <strong>Topik Asmara:</strong>
                                                                    </p>
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        {{ $additional->topikasmara === 'cocok' ? ' Aku cocok sama orang seperti apa?' : ' Gimana percintaanku sebulan kedepan?' }}
                                                                    </p>
                                                                </div>
