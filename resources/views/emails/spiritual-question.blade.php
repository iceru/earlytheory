...
<head>
    ...
    <title>Orders - Early Theory</title>
    <style>
        .wrapper {
            width: 100%;
        }
    ...
    <style>
        ...
        th.callout-inner.secondary {
            border: 1px solid #4A2984 !important;
            border-radius: 1rem;
            background: white;
        }

        th.callout-inner.secondary strong {
                                                                                            ...
                                                                                            <table>
                                                                                                <tr>
                                                                                                    <th>
                                                                                                        <p> <strong>Sales
                                                                                                                Number:</strong><br>
                                                                                                            {{ $additional->sales->sales_no }}
                                                                                                        </p>
                                                                                                        <p> <strong>Full
                                                                                                                Name</strong><br>
                                                                                                            {{ $additional->sales->user->name }}
                                                                                                        </p>
                                        ...
                                        <tbody>
                                            <tr>
                                                <th class="small-12 large-3 columns first">
                                                    <table>
                                                        <tr>
                                                            <th> <img width="200" class="logo-img"
                                                                    src="https://earlytheory.com/images/MainLogo.png"
                                                                    alt=""> </th>
                                                        </tr>
                                                    </table>
                                                </th>
