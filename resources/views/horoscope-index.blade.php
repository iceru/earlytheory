        ...
        @if (!$user)
            <div class="col-12">
                <div class="alert alert-info alert-dismissible fade show" role="alert">
                    ...
                    <p>Login sekarang untuk menyimpan hasil Birth Chart ke akun anda. <a href="/login"><strong>Login
                                Disini</strong></a></p>
                </div>
            </div>
        @endif
                ...
                <div class="col-12 col-lg-4 mb-3">
                    <div>
                        ...
                        <input type="text" class="form-control" name="birthdate" id="datepicker" placeholder=""
                            value="{{ $user ? \Carbon\Carbon::parse($user->birthdate)->toDateString() : '' }}" readonly>
                    </div>
                </div>
